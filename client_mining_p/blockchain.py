...
from uuid import uuid4 # ID users
...
class Blockchain(object):
    ...
    def new_block(self, proof, previous_hash=None):
        ...
        * Index
        * Timestamp
        * List of current transactions (empty for day 1)
        * The proof used to mine this block
        * The hash of the previous block
        :param proof: <int> The proof given by the Proof of Work algorithm (salt)
